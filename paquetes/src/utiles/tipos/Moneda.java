 ...
 * @author daniel
 */
public final class Moneda extends Number implements Comparable {
...
//    public static final Class<Moneda> TYPE = new Class<Moneda>();
    ...
    public Moneda(double d ) {
        value = new Double(d);
    }

    public Moneda(String string) throws NumberFormatException {
