 ...
 * @author daniel
 */
public final class Porcentual extends Number implements Comparable {
...
//    public static final Class<Moneda> TYPE = new Class<Moneda>();
    ...
    public Porcentual(double d ) {
        value = new Double(d);
    }

    public Porcentual(String string) throws NumberFormatException {
...
//    public int compareTo(Porcentual t) {
