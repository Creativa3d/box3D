 ...
 * @author daniel
 */
public final class Porcentual3Decimales extends Number implements Comparable {
...
//    public static final Class<Moneda> TYPE = new Class<Moneda>();
    ...
    public Porcentual3Decimales(double d ) {
        value = new Double(d);
    }

    public Porcentual3Decimales(String string) throws NumberFormatException {
...
//    public int compareTo(Porcentual3Decimales t) {
