/*
* JTEEUSUARIOSLISTAPERMISOS.java
*
* Creado el 31/3/2009
*/
...
public class JTEEUSUARIOSLISTAPERMISOS extends JTUSUARIOSLISTAPERMISOS {
    ...
    /**
     * Crea una instancia de la clase intermedia para la tabla USUARIOSLISTAPERMISOS incluyendole el servidor de datos
     */
    public JTEEUSUARIOSLISTAPERMISOS(IServerServidorDatos poServidorDatos) {
        super();
    ...
    public static JTEEUSUARIOSLISTAPERMISOS getTabla(final String psCODIGOUSUARIO,final String psOBJETO,final String psACCION,final IServerServidorDatos poServer) throws Exception {
        JTEEUSUARIOSLISTAPERMISOS loTabla = new JTEEUSUARIOSLISTAPERMISOS(poServer);
        if(getPasarCache()){
            ...
            loTabla.moList.getFiltro().addCondicion(
                    ...
                    new String[]{psCODIGOUSUARIO,psOBJETO,psACCION});
            loTabla.moList.filtrar();
        }else{
            loTabla.recuperarFiltradosNormal(new JListDatosFiltroElem(
                JListDatos.mclTIgual, malCamposPrincipales, new String[]{psCODIGOUSUARIO,psOBJETO,psACCION}) ,false);
        }
        return loTabla;
    }
