 ...
 * @author eduardo
 */
public class JPanelLineaPROPER extends JPanelEdicionAbstract implements ActionListener, FocusListener {
    ...
    public void setDatos(JxmlLinea poLinea, JxmlInforme poInforme){
        moLinea=poLinea;
        moInforme=poInforme;
    }
    ...
    public void mostrarDatos() throws Exception {
        mbMostrarDatos=true;
        try{
            txtNombre.setValueTabla(moLinea.getNombre());
            txtX.setValueTabla(String.valueOf(moLinea.getPunto1().getX()));
            txtY.setValueTabla(String.valueOf(moLinea.getPunto1().getY()));
            txtX2.setValueTabla(String.valueOf(moLinea.getPunto2().getX()));
            txtY2.setValueTabla(String.valueOf(moLinea.getPunto2().getY()));
            txtAncho.setValueTabla(String.valueOf(moLinea.getEstiloLinea().mdGrosor));
        }finally{
            mbMostrarDatos=false;
        }
    }
    ...
    public void establecerDatos() throws Exception {
        ...
        moLinea.setPunto1(loPos);
        loPos = new Point2D.Double(
                Double.valueOf(txtX2.getText()).doubleValue()
                , Double.valueOf(txtY2.getText()).doubleValue()
                );
        moLinea.getEstiloLinea().mdGrosor= (float) JConversiones.cdbl(txtAncho.getText());
        moLinea.setPunto2(loPos);
        moLinea.setNombre(txtNombre.getText());
        moLinea.firePropertyChange("", false, true);
    }
            ...
            loBus.getParametros().setCallBack(new CallBack<IPanelControlador>() {
                ...
                public void callBack(IPanelControlador poControlador) {
                    try {
                        ...
                        JMsgBox.mensajeErrorYLog(JPanelLineaPROPER.this, ex);
                    }
                }
            });
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            moInforme.getBanda(0).remove(moLinea);
            moLinea = new JxmlLinea();
            mostrarDatos();
        } catch (Exception ex) {
            JMsgBox.mensajeErrorYLog(this, ex);
        }
    ...
    private void btnClonarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClonarActionPerformed
        try {
            JxmlLinea loXML = (JxmlLinea) moLinea.clone();
