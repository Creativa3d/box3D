...
public class TimeSeries extends Series implements Cloneable, Serializable {
     ...
     * time period.
     *
     * @param name  the series name (null not permitted).
     */
     ...
     *
     * @param name  the name of the series (null not permitted).
     * @param domain  the domain description (null permitted).
     * @param range  the range description (null permitted).
     *
     * @since 1.0.13
     */
     ...
     *
     * @param description  the description (null permitted).
     *
     ...
     *
     * @return The time period class (may be null but only for
     *     an empty series).
     */
     ...
     *
     * @param period  the period of interest (null not allowed).
     *
     ...
     * period.
     *
     * @param period  the time period (null not permitted).
     *
     * @return The index.
     */
     ...
     *
     * @param period  time period (null not permitted).
     *
     * @return The value (possibly null).
     */
     ...
     *
     * @param item  the (timeperiod, value) pair (null not
     *              permitted).
     */
        ...
        if (count == 0) {
            ...
            if (item.getPeriod().compareTo(last) > 0) {
                ...
                if (index < 0) {
                    ...
                    JDepuracion.anadirTexto(getClass().getName(), b.toString());
//                    throw new SeriesException(b.toString());
                }
            }
        }
     ...
     *
     * @param period  the period (null not permitted).
     * @param value  the value.
     * 
     * @since 1.0.14
     */
     ...
     *
     * @param period  the time period to add/update (null not
     *                permitted).
     * @param value  the new value.
     *
     * @return A copy of the overwritten data item, or null if no
     ...
     * {@link SeriesChangeEvent} to all registered listeners.
     *
     * @param item  the data item (null not permitted).
     *
     * @return A copy of the overwritten data item, or null if no
     *         item was overwritten.
     *
     ...
     *
     * @param period  the period of the item to delete (null not
     *                permitted).
     */
...
we pass over to the more general method clone(start, end).
     ...
     * series.
     *
     * @param start  the first time period to copy (null not
     *         permitted).
     * @param end  the last time period to copy (null not
     *         permitted).
     *
     ...
     *
     * @param name  the series name (null not permitted).
     * @param timePeriodClass  the type of time period (null not
     *                         permitted).
     *
