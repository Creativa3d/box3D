...
public class TimeSeriesCollection extends AbstractIntervalXYDataset
     ...
     *
     * @param zone  the timezone (null permitted, will use
     ...
     *
     * @param series the series (null permitted).
     */
     ...
     *
     * @param series  a series to add to the collection (null
     *                permitted).
     * @param zone  the timezone (null permitted, will use
     *              TimeZone.getDefault() in that case).
     */
     ...
     * the domain.  If true, then only the x-values are considered
     * for the max and min values.  If false, then the start and
     ...
     *
     * @return The anchor position (never null).
     */
     ...
     *
     * @param anchor  the anchor position (null not permitted).
     */
     ...
     *
     * @param key  the series key (null permitted).
     *
