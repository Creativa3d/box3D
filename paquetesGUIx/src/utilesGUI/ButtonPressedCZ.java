...
public class ButtonPressedCZ extends Component {
  ...
  /**
   * Si está presionado
   * @param pbPresionado Si está presionado
   */
  ...
  /**
   * si cambia de estado al pulsar el botón alternativamente, si false solo cambia a pulsado aunque hagas muchas veces click
  ...
  /**
   * si cambia de estado al pulsar el botón alternativamente, si false solo cambia a pulsado aunque hagas muchas veces click
   * @param pbFalseCuandoTrue  si cambia de estado al pulsar el botón
   */
  ...
  /**
   * Color de la letra botón cuando esta pulsado
   * @return color
   */
   ...
   */
   ...
   /**Borra el focusListener espècificado*/
