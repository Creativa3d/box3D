 ...
 *
 */
public class ButtonPagina extends Component {
   ...
   */
  public ButtonPagina(String label) {
      super();
      this.label = label;
  ...
  public Dimension getPreferredSize() {
      Font f = getFont();
      Dimension loDim=null;
      if(f == null) {
	  loDim=new Dimension(100, 50);
      } else {
	  FontMetrics fm = getFontMetrics(getFont());
	  loDim=new Dimension(fm.stringWidth(label) + capWidth*2,
			       fm.getHeight() + 10);
      }
      return loDim;
  }
