 ...
 * JGrafXY.java
 *
 * Created on 19 de abril de 2004, 17:19
 */
...
/**Grafico XY y de barras*/
public class JGraf2 extends Canvas{
    ...
    */
     ...
     */
    public JGraf2(Class pcClaseX, String psTitulo) {
  ...
  public void paint(Graphics g2) {
    if (mbRefrescar){
      ...
      */
      ...
      moDatosX1.pintarLeyenda(g,mbLeyendaVisible,moEstiloLeyendaSerie,r.x, r.y, rLeyen, mbLeyendaSerieVertical);
