...
public class JEstiloPunto {
   ...
   * @param y y del punto
   */
  void pintar(JEjeCoordenadas poEjeCoordenadas,Object x, Object y){
    poEjeCoordenadas.setColor( moColor);
    if (mlEstilo==mclCirculo){
      poEjeCoordenadas.fillOvalPunto(x ,y, mlTamano, mlTamano);
    }else if (mlEstilo==mclCirculoHueco){
      poEjeCoordenadas.drawOvalPunto(x ,y, mlTamano, mlTamano);
    }else if (mlEstilo==mclCuadrado){
      poEjeCoordenadas.fillRectPunto(x ,y, mlTamano, mlTamano);
    }else if (mlEstilo==mclCuadradoHueco){
      poEjeCoordenadas.drawRectPunto(x ,y, mlTamano, mlTamano);
    }
  }
  /**
   * Pinta el punto en el objeto gráfico
