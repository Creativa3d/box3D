...
public class JTableModel extends AbstractTableModel implements TableModelListener, ITabla {
    ...
    private final IListaElementos moSortcolumn = new JListaElementos();
