...
public class JTextAreaCZ extends javax.swing.JTextArea implements utilesGUI.tabla.IComponentParaTabla, DocumentListener, BeanInfo, ITextBD {
...
//    protected ChangeEvent changeEvent;
    protected boolean mbAsocidoATabla = false;
     ...
     * NOTA: por ahora el tamano no funciona
     * @param plTipoBD tipo BD
     * @param plTamano tamaño
     */
...
//        if((e.getKeyCode() == '\n')||(e.getKeyCode() == '\b')||(e.getKeyCode() == ' ')){
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            ...
            PropertyDescriptor psc = new PropertyDescriptor("tipo", utilesGUIx.JTextAreaCZ.class);
