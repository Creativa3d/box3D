...
public class JT2GUIXEVENTOS  extends JT2GENERALBASE2 {
    ...
    public void mostrarFormPrinci() throws Exception {
        ...
        JMostrarPantallaParam loParam = new JMostrarPantallaParam(loPanel, 620, 600, JMostrarPantalla.mclEdicionInternal, "Tareas " + msNombreDefecto);
            ...
            SwingUtilities.invokeAndWait(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        loPanelMes.setControlador(JT2GUIXEVENTOS.this);
                        setPanel(loPanelMes);
                        ...
                        JT2GUIXEVENTOS.this.getParametros().getMostrarPantalla().mostrarForm(loParam);
                    } catch (Exception ex) {
                        moError = ex;
                    }
                }
