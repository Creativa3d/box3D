 ...
 * @author eduardo
 */
public class JPanelMoverComprimido extends javax.swing.JPanel {

    /**
     * Creates new form JPanelCopiaSeguridad
     */
    public JPanelMoverComprimido() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelCZ2.setText("Ficheros a incluir, si se deja en blanco todos (*.tif;*.jpg)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        try{
           JDatosGeneralesP.getDatosGenerales().getThreadGroup().addProcesoYEjecutar(new JProcesoAccionAbstracX() {
                ...
                public void procesar() throws Throwable {
                    JMoverComprimido.main(new String[]{
