...
public class JGeneradorJMain implements IModuloProyecto {
    ...
    public JGeneradorJMain(JProyecto poProyec) {
    ...
    public String getCodigo() {
        ...
        lsText.append(" * JMain.java");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("*");lsText.append(JUtiles.msRetornoCarro);
        ...
        lsText.append("");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("public class JMain {");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("    ");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("    /** Creates a new instance of JMain */");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("    public JMain() {");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("    }");lsText.append(JUtiles.msRetornoCarro);
        ...
        lsText.append("                    \""+moConex.getDirPadre()+".JPlugInPrincipal\",");lsText.append(JUtiles.msRetornoCarro);
        ...
        lsText.append("");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("        JGUIxConfigGlobal.getInstancia().setToolTipTextLabels(new JDevolverTextos(ResourceBundle.getBundle(\"ToolTipTextTablas\"+loParam.getNombreProyecto())));");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("        JGUIxConfigGlobal.getInstancia().setAyudaURLLabels(new JDevolverTextos(ResourceBundle.getBundle(\"AyudaURLTablas\"+loParam.getNombreProyecto())));");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("        JDatosGeneralesP.getDatosGenerales().mostrarLogin();");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("        JDatosGeneralesP.getDatosGenerales().mostrarFormPrincipal();");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("        } catch (Exception ex) {");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("            utilesGUIx.msgbox.JMsgBox.mensajeErrorYLog(new JLabel(), ex, \"JMain\");");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("        }");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("    }");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("");lsText.append(JUtiles.msRetornoCarro);
        lsText.append("}");lsText.append(JUtiles.msRetornoCarro);
